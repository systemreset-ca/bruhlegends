...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      fee_leg: "buy" | "sell";
      intent_status:
        "created" | "awaiting_payment" | "confirmed" | "expired" | "failed" | "cancelled";
      member_role: "member" | "moderator" | "admin";
      tip_privacy: "public" | "pseudonymous" | "anonymous" | "private";
      wallet_status: "unverified" | "verified" | "pending_replacement" | "revoked";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      ...
      detection_mode: ["command_only", "full_detection"],
      fee_leg: ["buy", "sell"],
      intent_status: ["created", "awaiting_payment", "confirmed", "expired", "failed", "cancelled"],
      member_role: ["member", "moderator", "admin"],
      tip_privacy: ["public", "pseudonymous", "anonymous", "private"],
      wallet_status: ["unverified", "verified", "pending_replacement", "revoked"],
    },
