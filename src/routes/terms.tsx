...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "BRUH Terms of Use — Devnet wallet beta, no financial advice" },
      {
        name: "description",
        content:
          "Terms for using the BRUH Telegram bot and Mini App: active Solana devnet wallet beta, group-administered, provided as-is with no investment advice.",
      },
  ...
  return (
    <PolicyPage
      ...
      sections={[
        ...
        {
          heading: "You keep control of your wallet",
          body: [
            "BRUH never asks for, imports or stores the private key or seed phrase of a wallet you already own, and it cannot initiate, reverse or recover a transfer from it. Every payment is constructed as a request that you approve in your own wallet, and the transaction happens directly between wallets on Solana.",
            "BRUH is currently running a Solana devnet wallet beta, and it is active. In a private chat, the bot creates or reuses one BRUH wallet for a verified Telegram account. Its key is generated by BRUH and stored encrypted, so that specific wallet is not non-custodial. It is shared by that account across every group it uses, while call records and statistics stay separate per group. Spending, key export and retirement are not available, the wallet exists on a test network only, and it holds no real value. Tipping is switched off while the beta runs.",
