      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            "A separate test-network feature, currently switched off, can generate one BRUH wallet for a verified Telegram account. Its key is generated by BRUH and stored encrypted, it is shared by that account across every group it uses while call records and statistics stay separate per group, and spending, key export and retirement are not available. It runs on a test network with no real value. When that feature is used, that specific wallet is not non-custodial.",
