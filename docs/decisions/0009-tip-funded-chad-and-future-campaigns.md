...
JEETER is proposed with 16 decimals. Solana's mint supply is an unsigned 64-bit base-unit integer: maximum supply at this precision is `1844.6744073709551615` whole tokens. See [Solana mint state](https://github.com/solana-foundation/solana-com/blob/main/apps/docs/content/docs/en/tokens/basics/create-mint.mdx). This is a precision constraint, not a chosen supply or deployed mint.
