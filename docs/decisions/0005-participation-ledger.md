...
Migration source: identical Supabase `20260913140000_participation_ledger.sql` and Drizzle `0014_participation_ledger.sql`. Filename 0013 remains reserved by unapplied PR #32; reconcile the Drizzle journal chronologically before integrating that proposal, so its older timestamp is not skipped. Generated blank Drizzle schema and platform Supabase types are not manually rewritten.
